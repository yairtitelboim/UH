                    ...
                    for (let idx = 0; idx < roadCoords.length - 1; idx++) {
                        ...
                        if (distToBuilding < 0.006 * totalScale) {
                            ...
                            for (let i = 0; i < particlesPerRoadSegment; i++) {
                                ...
                                // White particles (orderly pattern) - only if far enough from building
                                if (i % 3 === 0 && distToBuilding > 0.003 * totalScale) { // Increased distance threshold
                                    const waveSpeed = 2.0;
                                    ...
                                    // Only add white particles if we're far enough from the building
                                    greenBuildingParticles.features.push({
                                        type: 'Feature',
                                        properties: {
                                            particleSize: 2.0,  // Fixed size regardless of fade
                                            opacity: 0.2,       // Fixed opacity
                                            color: 'rgba(255, 255, 255, 0.2)'  // Fixed color and opacity
                                        },
                                        geometry: {
                                            type: 'Point',
                                            coordinates: [
