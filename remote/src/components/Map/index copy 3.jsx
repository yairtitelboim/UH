...
import powerGridIcon from '../../assets/power-grid.svg';
...
const MapComponent = (props) => {
  ...
  const WHITE_PARTICLE_COUNT = 8; // Number of white particles per road segment
  const WHITE_PARTICLE_SIZE = {
      MIN: 1.5,
      MAX: 3.0
  };
  const WHITE_PARTICLE_OPACITY = {
      MIN: 0.6,
      MAX: 0.9
  };
